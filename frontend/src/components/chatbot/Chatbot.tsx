...
export function Chatbot({ className = '', onClose }: ChatbotProps) {
  ...
  const handleSend = async (content: string) => {
    ...
    try {
      // Prepare chat history for API (convert to API format)
      // Filter out any messages with empty content and ensure valid roles
          ...
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-full flex items-center justify-center bg-indigo-50 dark:bg-indigo-900/40 text-indigo-600 dark:text-indigo-300">
              ...
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <path d="M12 4L10.5 7.5L7 9L10.5 10.5L12 14L13.5 10.5L17 9L13.5 7.5L12 4Z" fill="currentColor" opacity="0.4" />
              </svg>
            </div>
